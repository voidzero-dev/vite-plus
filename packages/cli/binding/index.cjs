    ...
    try {
      ...
      if (!candidateFailed) {
        if (
          ...
          if (bindingPackageVersion !== '1.0.0-rc.1') {
            throw new Error(
              `WASI binding package version mismatch, expected 1.0.0-rc.1 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`,
            );
          }
        }
