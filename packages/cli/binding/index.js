  ...
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'x64') {
      ...
      if (isMusl()) {
        ...
        try {
          const binding = require('@vite-plus-linux-arm-musleabihf');
          const bindingPackageVersion =
            require('@vite-plus-linux-arm-musleabihf/package.json').version;
          if (
            bindingPackageVersion !== '0.0.0' &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
        ...
        try {
          ...
          const bindingPackageVersion =
            require('@vite-plus-linux-arm-gnueabihf/package.json').version;
          if (
            bindingPackageVersion !== '0.0.0' &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require('@vite-plus-linux-loong64-musl/package.json').version;
          if (
            bindingPackageVersion !== '0.0.0' &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
        ...
        try {
          ...
          const bindingPackageVersion =
            require('@vite-plus-linux-loong64-gnu/package.json').version;
          if (
            bindingPackageVersion !== '0.0.0' &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
      ...
      if (isMusl()) {
        ...
        try {
          const binding = require('@vite-plus-linux-riscv64-musl');
          const bindingPackageVersion =
            require('@vite-plus-linux-riscv64-musl/package.json').version;
          if (
            bindingPackageVersion !== '0.0.0' &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
        ...
        try {
          const binding = require('@vite-plus-linux-riscv64-gnu');
          const bindingPackageVersion =
            require('@vite-plus-linux-riscv64-gnu/package.json').version;
          if (
            bindingPackageVersion !== '0.0.0' &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
...
const { detectWorkspace, downloadPackageManager, rewriteScripts, run, runCommand } = nativeBinding;
