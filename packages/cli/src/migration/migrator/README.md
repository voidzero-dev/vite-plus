...
| `vitest-v5.ts`           | Versioned Vitest v5 preflight, compatibility edits, review findings, and completion state. Pure AST and command transforms live under `../vitest-v5/`.                                                                  |
