  ...
  sections: [
      ...
      rows: [
        {
          ...
          description: [
            ...
            `- Org scope: ${accent('@your-org')} → picker from ${accent('@your-org/create')}'s ${accent('vp.templates')} manifest`,
            `- Org entry: ${accent('@your-org/web')} → manifest entry "web" (falls back to ${accent('@your-org/create-web')})`,
    ...
    },
    {
      ...
      lines: [
        ...
        `  ${accent('vp create @your-org/web')} ${muted('# direct selection')}`,
      ],
    },
  ],
});
