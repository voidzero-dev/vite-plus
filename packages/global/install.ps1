...
function Get-LatestVersion {
    try {
        $response = Invoke-RestMethod "https://registry.npmjs.org/vite-plus-cli/latest"
...
function Main {
    ...
    $binaryUrl = "https://registry.npmjs.org/$packageName/-/vite-plus-cli-$packageSuffix-$ViteVersion.tgz"
