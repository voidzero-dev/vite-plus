...
Vite Task uses [automatic tracking](/guide/automatic-tracking) to learn what each task needs for caching so you don't have to configure it manually. Automatic tracking has two tiers:
