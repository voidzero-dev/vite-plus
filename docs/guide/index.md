...
You can [view the setup instructions](https://viteplus.dev/agent-setup/prompt.md), update the installed skill with `vp dlx skills update vite-plus --global --yes`, or remove it with `vp dlx skills remove vite-plus --global --yes`.
