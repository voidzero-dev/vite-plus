...
Instead, Vite+ manages its own global packages under `packages/` in the resolved data directory, allowing them to remain available across different Node.js versions.
