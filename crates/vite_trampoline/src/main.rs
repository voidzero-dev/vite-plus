...
/// console group. By returning TRUE, we tell Windows we handled the event
...
fn install_ctrl_handler() {
    ...
    unsafe extern "system" fn handler(_ctrl_type: u32) -> windows_core::BOOL {
        windows_core::BOOL(1) // TRUE - signal handled (ignored)
    }
