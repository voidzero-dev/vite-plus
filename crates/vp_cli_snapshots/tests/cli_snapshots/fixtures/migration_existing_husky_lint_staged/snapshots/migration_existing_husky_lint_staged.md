# migration_existing_husky_lint_staged
...
migration should preserve Husky and lint-staged
...
prepare, dependencies, and lint-staged config should remain
...
no staged config should be introduced
