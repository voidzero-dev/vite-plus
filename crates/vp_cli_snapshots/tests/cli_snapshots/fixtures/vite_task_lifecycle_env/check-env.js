...
// package-manager detection channels. The user-agent platform/arch tail
// (`linux x64`) is the one machine-dependent value the suite redaction does
// not mask, so it is normalized here from the runtime's own platform/arch.
