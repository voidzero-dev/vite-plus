...
Automatic discovery should apply the lint block in vite.config.ts.
...
Automatic discovery should apply the fmt block in vite.config.ts.
...
## `vp fmt -c vite.config.ts --check src`
