...
.nvmrc
  1:1 REVIEW [node-runtime] Resolve .nvmrc (node) and select Node ^22.18.0 || ^24.11.0 || >=26.0.0.
...
.node-version
  1:1 REVIEW [node-runtime] Resolve .node-version (lts/*) and select Node ^22.18.0 || ^24.11.0 || >=26.0.0.
```
