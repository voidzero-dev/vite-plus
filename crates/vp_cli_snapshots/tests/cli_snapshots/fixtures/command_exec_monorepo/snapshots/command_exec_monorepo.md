...
recursive + shell mode (vp's own shell expands the variable)
...
multiple exclusion-only filters
...
multiple inclusion filters (union)
...
exclusion of nonexistent pkg returns all
