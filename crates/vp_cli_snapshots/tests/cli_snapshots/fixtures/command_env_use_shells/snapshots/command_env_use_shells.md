...
should detect bash and output posix export
...
should detect zsh and output posix export
...
should detect fish and output fish export
...
should detect nushell and output nushell export
...
should detect powershell and output powershell export
...
should detect cmd and output cmd export
