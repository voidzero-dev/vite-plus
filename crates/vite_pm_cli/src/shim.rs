...
pub(crate) fn native_sh_shim(relative_file: &str) -> String {
    formatdoc! {
        r#"
        #!/bin/sh
...
pub(crate) fn native_cmd_shim(relative_file: &str) -> String {
    formatdoc! {
        r#"
        @SETLOCAL
        @"%~dp0\{relative_file}" %*
...
pub(crate) fn native_pwsh_shim(relative_file: &str) -> String {
    formatdoc! {
        r#"
        #!/usr/bin/env pwsh
