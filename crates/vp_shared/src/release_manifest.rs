//! Release-focused `package.json` parsing and editing utilities.
//!
...
///
/// ```rust
/// use vp_shared::replace_top_level_string_property;
///
/// let input = r#"{
///   "version": "1.0.0",
...
///
/// ```rust
/// use vp_shared::{WorkspaceReference, WorkspaceVersionSpec, parse_workspace_reference};
///
/// assert!(matches!(
