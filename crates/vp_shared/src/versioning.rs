...
///
/// ```rust
/// use vp_shared::{VersionPattern, VersionPrefix, parse_version_pattern};
///
...
///
/// ```rust
/// use vp_shared::{Version, VersionBump, bump_version};
///
...
///
/// ```rust
/// use vp_shared::build_prerelease;
///
